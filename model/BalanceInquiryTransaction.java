...
public class BalanceInquiryTransaction extends Transaction
{
	...
	protected View createView()
	{
		...
		View localView = (View)myViews.get("BalanceInquiryTransactionView");

		if (localView == null)
		{
				// create our initial view
				localView = ViewFactory.createView("BalanceInquiryTransactionView", this);

				myViews.put("BalanceInquiryTransactionView", localView);
	...
	{
		// create our initial view
		View localView = ViewFactory.createView("BalanceInquiryReceipt", this);

		myViews.put("BalanceInquiryReceiptView", localView);
