...
public class TransferTransaction extends Transaction
{
	...
	protected View createView()
	{
		...
		View localView = (View)myViews.get("TransferTransactionView");

		if (localView == null)
		{
				// create our initial view
				localView = ViewFactory.createView("TransferTransactionView", this);

				myViews.put("TransferTransactionView", localView);
	...
	{
		View localView = ViewFactory.createView("TransferReceipt", this);

		myViews.put("TransferReceipt", localView);
