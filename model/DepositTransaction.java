...
public class DepositTransaction extends Transaction
{
	...
	{
		View localView = (View)myViews.get("DepositTransactionView");

		if (localView == null)
		{
				// create our initial view
				localView = ViewFactory.createView("DepositTransactionView", this);

				myViews.put("DepositTransactionView", localView);
	...
	{
		View localView = (View)myViews.get("DepositAmountView");

		if (localView == null)
		{
				// create our initial view
				localView = ViewFactory.createView("DepositAmountView", this);

				myViews.put("DepositAmountView", localView);
	...
	protected void createAndShowReceiptView()
	{
		...
		// create our initial view
		View localView = ViewFactory.createView("DepositReceipt", this);

		myViews.put("DepositReceipt", localView);
